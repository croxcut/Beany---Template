...
class ModelRunner @Inject constructor(
    ...
    fun setup() {
        ...
        context.assets.open(labelPath).use { input ->
    ...
    fun detect(bitmap: Bitmap): Pair<List<AABB>, Long>? {
        ...
        return boxes?.let { it to inferenceTime }
    }
    ...
    fun isCleared(): Boolean = interpreter == null

    private fun bestBox(array: FloatArray) : List<AABB>? {

        val boundingBoxes = mutableListOf<AABB>()
    ...
    interface DetectorListener {
        fun onEmptyDetect()
        fun onDetect(boundingBoxes: List<AABB>, inferenceTime: Long)
    }
